...
function massalia_insert_js_in_footer(){
	...
	wp_enqueue_script( 'rwd', get_template_directory_uri().'/js/gestion-menu-rwd.js',array('jquery'),1.0,true);
	wp_enqueue_script( 'evitement', get_template_directory_uri().'/js/gestion-evitement.js',array('jquery'),1.0,true);
}
